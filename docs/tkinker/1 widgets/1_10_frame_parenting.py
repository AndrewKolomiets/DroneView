...
exercise_frame = ttk.Frame(window, relief = tk.GROOVE)
...
#ttk.Label(exercise_frame, text = 'label in frame 2').grid(column=0, row=0)
#ttk.Button(exercise_frame, text = 'button in frame 2').grid(column=0, row=1)
#ttk.Entry(exercise_frame).grid(column=1, row=0)
